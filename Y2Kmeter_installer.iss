...
; 结合 [InstallDelete] 强制先删除旧 EXE，确保 1.1.x → 1.6.0 升级一定覆盖成功。
; -----------------------------------------------------------------------
...
[Files]
; Standalone EXE
Source: "build\ninja-msvc\Y2Kmeter_artefacts\Release\Standalone\{#MyAppExeName}"; \
    DestDir: "{app}"; \
    Flags: ignoreversion; \
...
Source: "build\ninja-msvc\Y2Kmeter_artefacts\Release\VST3\{#MyPluginBundle}\*"; \
